      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="w-full max-w-sm rounded-xl border bg-white p-8 shadow-sm">
          ...
          <input
            ...
            className="mb-4 w-full rounded-lg border px-4 py-2.5 text-sm focus:border-[#1A7A52] focus:outline-none"
          />
          <button
            onClick={handleLogin}
            className="w-full rounded-lg bg-[#1A7A52] py-2.5 text-sm font-bold text-white hover:bg-[#14634A]"
          >
            Login
          </button>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between border-b bg-white px-6 py-3 shadow-sm">
        <div className="flex items-center gap-4">
          <h1 className="text-lg font-bold text-[#191919]">Top Online Therapy CMS</h1>
          <div className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 py-1 pl-3 pr-1">
            ...
            <select
              ...
              className="rounded-md border border-gray-200 bg-white px-2.5 py-1 text-sm font-semibold text-[#1A7A52] focus:outline-none focus:ring-2 focus:ring-[#1A7A52]/30"
            >
              {VERTICALS.map((v) => (
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="rounded-lg bg-[#1A7A52] px-6 py-2 text-sm font-bold text-white hover:bg-[#14634A] disabled:opacity-50"
          >
      ...
      <div className="mx-auto max-w-5xl px-6 py-6">
        ...
        {activeTab === "providers" && (
          <div className="space-y-4">
                ...
                <div key={provider.id} className="rounded-xl border bg-white p-6 shadow-sm">
                    ...
                    <div className="space-y-2">
                      {provider.highlights.map((h, hi) => (
                        <input
                          ...
                          className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none"
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50/50 p-4">
                    ...
                    <label className="mb-3 flex items-center gap-2 text-sm font-medium text-gray-800">
                      <input
                        ...
                        className="h-4 w-4 rounded border-gray-300 text-[#1A7A52] focus:ring-[#1A7A52]"
                      />
                  ...
                  <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50/50 p-4">
                      ...
                      {(provider.trustpilotReviews ?? []).map((r, ri) => (
                        <div key={ri} className="rounded-lg border bg-white p-4">
                          <div className="mb-2 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              <select
                                ...
                                className="rounded border px-2 py-1 text-xs focus:border-[#1A7A52] focus:outline-none"
                              >
                                {[5, 4, 3, 2, 1].map((n) => (
                          ...
                          <input
                            ...
                            className="mb-2 w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none"
                          />
                          <textarea
                            value={r.text}
                          ...
                          <div className="flex gap-2">
                            <input value={r.name} onChange={(e) => updateTrustpilotReview(index, ri, "name", e.target.value)}
                              placeholder="Name (e.g. Sarah M.)" className="flex-1 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none" />
                            <input value={r.location} onChange={(e) => updateTrustpilotReview(index, ri, "location", e.target.value)}
                              placeholder="Location (e.g. TX)" className="w-32 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none" />
                          </div>
                        </div>
                      ))}
                    </div>
                    <button
                      ...
                      className="mt-2 w-full rounded border-2 border-dashed border-gray-200 py-2 text-xs font-medium text-gray-400 hover:border-[#1A7A52] hover:text-[#1A7A52]"
                    >
            ...
            <button
              onClick={addProvider}
              className="w-full rounded-lg border-2 border-dashed border-gray-300 py-4 text-sm font-medium text-gray-400 hover:border-[#1A7A52] hover:text-[#1A7A52]"
            >
              + Add Provider
            </button>
          </div>
            ...
            <div className="rounded-xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-3 flex gap-2">
                <select
                  ...
                  className="flex-1 rounded border px-3 py-2 text-sm text-gray-600 focus:border-[#1A7A52] focus:outline-none"
                  defaultValue=""
                >
                ...
                <button
                  ...
                  className="rounded border border-[#1A7A52] px-4 py-2 text-xs font-semibold text-[#1A7A52] hover:bg-[#1A7A52]/5"
                >
                  Add
                </button>
              </div>
        ...
        {activeTab === "sidebar" && (
          <div className="space-y-4">
            ...
            <div className="rounded-xl border bg-white p-6 shadow-sm">
              ...
              <select
                className="w-full rounded border px-3 py-1.5 text-sm text-gray-600 focus:border-[#1A7A52] focus:outline-none"
                value=""
                onChange={(e) => {
              ...
              <div key={article.slug || index} className="rounded-xl border bg-white p-6 shadow-sm">
                ...
                <div className="mt-5">
                  ...
                  <button
                    ...
                    className="mt-2 rounded border border-dashed border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-400 hover:border-[#1A7A52] hover:text-[#1A7A52]"
                  >
                    + Add Section
                  </button>
                </div>
                ...
                <div key={battle.slug || index} className="rounded-xl border bg-white p-6 shadow-sm">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <select value={battle.provider1Id} onChange={(e) => updateBattle({ provider1Id: e.target.value })} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none">
                    ...
                    <div>
                      ...
                      <select value={battle.provider2Id} onChange={(e) => updateBattle({ provider2Id: e.target.value })} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none">
                        <option value="">Select...</option>
                        {config.providers.map((p) => (<option key={p.id} value={p.id}>{p.name}</option>))}
                      </select>
                    </div>
                    <div>
                      ...
                      <select value={battle.winnerId} onChange={(e) => updateBattle({ winnerId: e.target.value })} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none">
                        <option value="">Select...</option>
                  ...
                  <div className="mt-4">
                    ...
                    <textarea value={battle.intro} onChange={(e) => updateBattle({ intro: e.target.value })} rows={3} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                  </div>

                  <div className="mt-4">
                    <label className="mb-1 block text-xs font-semibold text-gray-500 uppercase tracking-wider">Verdict</label>
                    <textarea value={battle.verdict} onChange={(e) => updateBattle({ verdict: e.target.value })} rows={3} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                  </div>
                  ...
                  <div className="mt-5">
                      ...
                      {(battle.categories ?? []).map((cat, ci) => (
                        <div key={ci} className="rounded-lg border bg-gray-50 p-4">
                          ...
                          <div className="grid gap-3 sm:grid-cols-2">
                            ...
                            <div>
                              <label className="mb-1 block text-xs font-semibold text-gray-500 uppercase tracking-wider">Winner</label>
                              <select value={cat.winner || ""} onChange={(e) => { const cats = [...battle.categories]; cats[ci] = { ...cats[ci], winner: e.target.value as "provider1" | "provider2" | "tie" }; updateBattle({ categories: cats }); }} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none">
                          ...
                          <div className="mt-2">
                            ...
                            <textarea value={cat.explanation || ""} onChange={(e) => { const cats = [...battle.categories]; cats[ci] = { ...cats[ci], explanation: e.target.value }; updateBattle({ categories: cats }); }} rows={2} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                          </div>
                          <ArrayField
                    ...
                    <button onClick={() => updateBattle({ categories: [...battle.categories, { name: "", winner: "tie" as const, explanation: "", supportingPoints: [] }] })} className="mt-2 rounded border border-dashed border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-400 hover:border-[#1A7A52] hover:text-[#1A7A52]">+ Add Category</button>
                  </div>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="space-y-2">
                      {(battle.features ?? []).map((feat, fi) => (
                        <div key={fi} className="flex gap-2 items-start">
                          <div className="grid flex-1 gap-2 sm:grid-cols-3">
                            <input value={feat.feature} onChange={(e) => { const feats = [...(battle.features ?? [])]; feats[fi] = { ...feats[fi], feature: e.target.value }; updateBattle({ features: feats }); }} placeholder="Feature" className="rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                            <input value={feat.provider1Value} onChange={(e) => { const feats = [...(battle.features ?? [])]; feats[fi] = { ...feats[fi], provider1Value: e.target.value }; updateBattle({ features: feats }); }} placeholder={bp1?.name ?? "Provider 1"} className="rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                            <input value={feat.provider2Value} onChange={(e) => { const feats = [...(battle.features ?? [])]; feats[fi] = { ...feats[fi], provider2Value: e.target.value }; updateBattle({ features: feats }); }} placeholder={bp2?.name ?? "Provider 2"} className="rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                          </div>
                    ...
                    <button onClick={() => updateBattle({ features: [...(battle.features ?? []), { feature: "", provider1Value: "", provider2Value: "" }] })} className="mt-2 rounded border border-dashed border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-400 hover:border-[#1A7A52] hover:text-[#1A7A52]">+ Add Feature Row</button>
                  </div>
                </div>
              );
            })}
            <button
              onClick={() => {
                const newBattle: BattleData = {
                  ...
                  features: [
                    { feature: "Session Formats", provider1Value: "", provider2Value: "" },
        ...
        {activeTab === "pages" && (
          <div className="space-y-4">
            <p className="text-xs text-gray-400">Create comparison landing pages (e.g. /cheapest-online-therapy, /best-online-therapy-for-anxiety). Same layout as the homepage but with custom hero text and provider ranking.</p>
                  ...
                  <div className="mt-5">
                    ...
                    <div className="mt-2 flex gap-2">
                      <select
                        ...
                        className="flex-1 rounded border px-3 py-1.5 text-sm text-gray-600 focus:border-[#1A7A52] focus:outline-none"
                        defaultValue=""
                      >
                      ...
                      <button
                        ...
                        className="rounded border border-[#1A7A52] px-3 py-1.5 text-xs font-semibold text-[#1A7A52] hover:bg-[#1A7A52]/5"
                      >
                        Add
                      </button>
                    </div>
                        ...
                        <div key={si} className="rounded-lg border bg-gray-50 p-4">
                          ...
                          <div className="mt-2">
                            ...
                            <textarea
                              ...
                              rows={3}
                              className="w-full rounded border px-3 py-2 text-sm text-gray-800 focus:border-[#1A7A52] focus:outline-none"
                            />
                          </div>
                          <div className="mt-2">
                ...
                <div key={sb.id || index} className="rounded-xl border bg-white p-6 shadow-sm">
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    ...
                    <div>
                      ...
                      <select value={sb.area} onChange={(e) => updateSB({ area: e.target.value })} className="w-full rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-1.5 flex gap-2">
                      <select id={`sb-prov-${index}`} className="flex-1 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none" defaultValue="">
                        <option value="" disabled>Add provider...</option>
                        {config.providers.filter((p) => !(sb.providerIds ?? []).includes(p.id)).map((p) => (<option key={p.id} value={p.id}>{p.name}</option>))}
                      </select>
                      <button onClick={() => { const el = document.getElementById(`sb-prov-${index}`) as HTMLSelectElement; if (el?.value) { updateSB({ providerIds: [...(sb.providerIds ?? []), el.value] }); el.value = ""; } }} className="rounded border border-[#1A7A52] px-3 py-1.5 text-xs font-semibold text-[#1A7A52] hover:bg-[#1A7A52]/5">Add</button>
                    </div>
                  </div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-1.5 flex gap-2">
                      <select id={`sb-art-${index}`} className="flex-1 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none" defaultValue="">
                      ...
                      <button onClick={() => { const el = document.getElementById(`sb-art-${index}`) as HTMLSelectElement; if (el?.value) { updateSB({ articleSlugs: [...(sb.articleSlugs ?? []), el.value] }); el.value = ""; } }} className="rounded border border-[#1A7A52] px-3 py-1.5 text-xs font-semibold text-[#1A7A52] hover:bg-[#1A7A52]/5">Add</button>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border bg-white p-6 shadow-sm">
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-lg border px-4 py-3 text-sm font-medium transition-colors ${
                      (config.quiz.panelType || "classic") === type
                        ? "border-[#1A7A52] bg-[#1A7A52]/5 text-[#1A7A52]"
              ...
              <p className="mt-2 text-xs text-gray-400">
                Classic: <span className="font-medium">/find-your-match</span>
              </p>
            </div>
                ...
                {(config.quiz.testimonials ?? []).map((t, ti) => (
                  <div key={ti} className="rounded-lg border bg-gray-50 p-4">
                    ...
                    <textarea
                      ...
                      className="mb-2 w-full rounded border px-3 py-2 text-sm text-gray-800 focus:border-[#1A7A52] focus:outline-none"
                    />
                    <div className="flex gap-2">
                      <input
                        value={t.name}
                        ...
                        className="flex-1 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none"
                      />
                      <input
                        value={t.state}
                        onChange={(e) => {
                        ...
                        className="w-32 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none"
                      />
                    </div>
                  </div>
                ))}
                    ...
                    {q.options.map((opt, oi) => (
                      <div key={oi} className="flex gap-2">
                        <input value={opt.label} onChange={(e) => {
                          ...
                          setConfig({ ...config, quiz: { ...config.quiz, questions } });
                        }} placeholder="Label" className="flex-1 rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                        <input value={opt.value} onChange={(e) => {
                          ...
                          questions[qi] = { ...questions[qi], options };
                          setConfig({ ...config, quiz: { ...config.quiz, questions } });
                        }} placeholder="Value" className="w-28 rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none" />
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="rounded-xl border bg-white p-6 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {[
                  ...
                  { key: "online", label: "Fast Online Start" },
                  ...
                  return (
                    <div key={key} className="rounded-lg border bg-gray-50 p-3">
                      <p className="mb-2 text-xs font-bold text-[#1A7A52]">{label}</p>
                      ...
                      <select
                        className="w-full rounded border px-2 py-1 text-xs text-gray-500 focus:border-[#1A7A52] focus:outline-none"
                        value=""
                        onChange={(e) => {
                          if (!e.target.value) return;
                  ...
                  <div key={ti} className="rounded-lg border bg-gray-50 p-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <input value={t.state} onChange={(e) => { const ts = [...(config.reviewTestimonials ?? [])]; ts[ti] = { ...ts[ti], state: e.target.value }; setConfig({ ...config, reviewTestimonials: ts }); }}
                        placeholder="State" className="w-28 rounded border px-3 py-1.5 text-sm focus:border-[#1A7A52] focus:outline-none" />
                    </div>
                  </div>
                ))}
              </div>
    ...
    <div>
      ...
      <div className="flex gap-2">
        <input
          ...
          value={value}
          onChange={(e) => onChange(e.target.value)}
          className="flex-1 rounded border px-3 py-2 text-sm focus:border-[#1A7A52] focus:outline-none"
          placeholder="URL or upload..."
        />
        <label className="flex cursor-pointer items-center gap-1 rounded border border-[#1A7A52] px-3 py-2 text-xs font-semibold text-[#1A7A52] hover:bg-[#1A7A52]/5">
