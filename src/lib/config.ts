...
export const CONTENT_LAST_UPDATED = "2026-09-19";
...
export const TEMPLATES_LAST_UPDATED = "2026-09-19";
...
// Single-vertical build: this standalone site is online therapy only. The
// array shape is kept (the platform types expect it) but holds just the one
// vertical, served at the domain root.
export const VERTICALS: Vertical[] = [
  { id: "online-therapy", name: "Online Therapy", tagline: "Compare the best online therapy and mental-health platforms", accent: "#1A7A52" },
];

export const DEFAULT_VERTICAL = "online-therapy";
...
export const PUBLISHED_VERTICALS = ["online-therapy"];
...
export const HIDDEN_VERTICALS: string[] = [];
...
// Article slugs kept out of the index. Empty on this single-vertical online-therapy build -
// add a slug here to noindex a specific article.
...
export const NOINDEX_WL_REVIEW_SLUGS = new Set<string>([]);
...
export const NOINDEX_WL_BATTLE_SLUGS = new Set<string>([]);
...
export const WEIGHT_LOSS_HERO_TEXT = {
  ...
  description:
    "Compare licensed online therapy platforms by insurance coverage, session formats, therapist matching and value.",
};
...
export const defaultConfig: SiteConfig = {
  ...
  sidebar: {
    ...
    socialProofText:
      "people compared online therapy platforms on our site this month.",
  ...
  quiz: {
    ...
    welcomeSubtitle: "Answer a few quick questions and we'll compare trusted online therapy platforms based on your goals, preferences, and budget.",
    ...
    pageSubtitle: "Answer a few quick questions to help us compare platforms based on your goals, session preferences, and budget.",
    ...
    loadingMessages: ["Comparing trusted providers...", "Reviewing session formats...", "Finding your best match...", "Preparing your recommendation..."],
    questions: [],
    providerProfiles: [],
  },
};
