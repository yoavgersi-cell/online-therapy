  ...
  return (
    <>
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        <Link
          href={href("/")}
          className="inline-flex h-[46px] items-center justify-center gap-2 rounded-xl bg-[#1A7A52] px-6 text-[14px] font-bold text-white transition-colors hover:bg-[#14634A]"
        >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {topProviders.map((p) => (
              <Link
                ...
                className="group flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 transition-colors hover:border-[#1A7A52]/30"
              >
                ...
                <span className="ml-auto text-[13px] font-semibold text-[#1A7A52] group-hover:underline">Read review</span>
              </Link>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {comparisons.map((c) => (
              <Link
                key={c.slug}
                href={href(`/${c.slug}`)}
                className="group flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 text-[13px] font-semibold text-[#191919] transition-colors hover:border-[#1A7A52]/30"
              >
                {c.name}
                <ArrowRight className="ml-auto h-3.5 w-3.5 shrink-0 text-[#1A7A52]" strokeWidth={2.5} />
              </Link>
            ))}
          </div>
        </div>
