...
export async function articlesIndexMetadata(ctx: SiteContext): Promise<Metadata> {
  ...
  const description =
    ctx.vertical === "weight-loss"
      ...
      : `Evidence-based ${vName.toLowerCase()} guides for 2026 - how it works, insurance and costs, what to expect, and how to choose the right platform.`;
  return {
    title,
    description,
        ...
        >
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="flex flex-1 flex-col justify-center p-6 sm:p-8">
              ...
              <h2 className="text-[20px] font-bold leading-tight text-[#191919] group-hover:text-[#1A7A52] transition-colors sm:text-[22px]">
                {articles[0].title}
              </h2>
              <p className="mt-2 text-[14px] leading-relaxed text-gray-500 line-clamp-2">
                {articles[0].description}
              </p>
              <span className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#1A7A52]">
                Read article
          ...
          {articles.slice(1).map((article, i) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <h2 className="text-[16px] font-bold leading-snug text-[#191919] group-hover:text-[#1A7A52] transition-colors">
                  {article.title}
                </h2>
        ...
        {guides.length > 0 && (
          <div className="mt-14">
            <div className="mb-8">
              ...
              <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-gray-500">
                Deeper explainers on platforms, costs and what to expect - with side-by-side data.
              </p>
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {guides.map((g) => (
                ...
                >
                  ...
                  <h3 className="text-[16px] font-bold leading-snug text-[#191919] transition-colors group-hover:text-[#1A7A52]">
                    {g.title}
                  </h3>
                  <p className="mt-2 flex-1 text-[13px] leading-relaxed text-gray-500 line-clamp-3">
                    {g.description}
          ...
          <div id="comparisons" className="mt-14 scroll-mt-24">
            <div className="mb-8">
              ...
              <p className="mt-2 max-w-2xl text-[15px] leading-relaxed text-gray-500">
                ...
                side by side on pricing, session formats, and support - and which one we&apos;d pick.
              </p>
            </div>
              ...
              {comparisons.map(({ battle, p1, p2, winner }) => (
                ...
                >
                  ...
                  <div className="mb-5 flex items-center justify-between gap-3">
                    ...
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border-2 border-[#1A7A52]/20 bg-white text-[11px] font-extrabold text-[#1A7A52]">
                      VS
                    </span>
                    <div className="flex h-[36px] flex-1 items-center justify-center">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                  ...
                  <h3 className="text-center text-[16px] font-bold leading-snug text-[#191919] group-hover:text-[#1A7A52] transition-colors">
                    {p1.name} vs {p2.name}
                  </h3>
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-gray-100 pt-4">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#1A7A52]">
                      Compare
                      <ArrowRight className="h-3.5 w-3.5" strokeWidth={2} />
                    </span>
                  </div>
