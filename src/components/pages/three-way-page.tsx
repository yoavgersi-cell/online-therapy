...
// Three-way pages are not used on this single-vertical site (the registry is
// empty), so this component never renders; the rows are kept generic.
  ...
  return (
    <div className="bg-[#FAFAFA]">
      ...
      <div className="mx-auto max-w-[1100px] px-4 pb-16 pt-10 sm:px-6">
          ...
          {providers.map((p) => (
            <div key={p.id} className="flex flex-col rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <ProviderCta
                ...
                className="flex h-[42px] items-center justify-center gap-1.5 rounded-xl bg-[#1A7A52] text-[13.5px] font-bold text-white transition-colors hover:bg-[#14634A]"
              >
                Visit {p.name}
        ...
        {/* Verdict */}
        <div className="mb-12 rounded-2xl border border-[#1A7A52]/20 bg-white p-6 shadow-sm sm:p-8">
          <p className="mb-2.5 text-[12px] font-bold uppercase tracking-[0.07em] text-[#1A7A52]">Our verdict</p>
