...
function GroupLabel({ icon: Icon, children }: { icon: typeof FileText; children: React.ReactNode }) {
  return (
    <div className="mb-2.5 flex items-center gap-2">
      <Icon className="h-[15px] w-[15px] text-[#1A7A52]" strokeWidth={2} />
    ...
    <section className="mt-12 overflow-hidden rounded-2xl border border-gray-200 bg-white">
      <div className="border-b border-gray-100 bg-gray-50/70 px-6 py-4 sm:px-7">
        <div className="flex items-center gap-2.5">
          <ClipboardCheck className="h-[18px] w-[18px] text-[#1A7A52]" strokeWidth={2} />
        ...
        <div className="grid gap-x-10 gap-y-7 sm:grid-cols-2">
          ...
          <div>
                  ...
                  {kind === "review" ? (
                    ...
                    <>
                      <a
                        ...
                        className="font-semibold text-[#1A7A52] underline underline-offset-2 hover:text-[#14634A]"
                      >
                        {p.name}
                      </a>
            ...
            <p className="mt-3 inline-flex items-center gap-1.5 rounded-md bg-gray-50 px-2.5 py-1 text-[12px] font-semibold text-gray-500">
              <ClipboardCheck className="h-3.5 w-3.5 text-[#1A7A52]" strokeWidth={2} />
                  ...
                  <li key={i} className="flex gap-2 text-[13px] leading-relaxed">
                    ...
                    <span className="text-gray-600">
                      <a
                        ...
                        className="inline font-medium text-[#1A7A52] underline underline-offset-2 hover:text-[#14634A]"
                      >
                        {s.label}
