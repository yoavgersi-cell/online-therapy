...
// leans on friction-reducers that are true for every platform we list.
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-t-2xl border-t border-gray-200 bg-white/95 shadow-[0_-6px_24px_rgba(0,0,0,0.10)] backdrop-blur">
        {/* Brand accent line */}
        <div className="h-[3px] bg-gradient-to-r from-[#1A7A52] via-[#4FB286] to-[#1A7A52]" />
              ...
              return (
                <div key={p.id} className="min-w-0">
                  {recommendedId != null && (
                    <p
                      className={`mb-1 text-center text-[10px] font-bold uppercase tracking-[0.08em] ${
                        isPick ? "text-[#1A7A52]" : "text-transparent"
                      }`}
                    >
                      Our pick
                    </p>
                  ...
                  <ProviderCta
                    ...
                    className={
                      isOther
                        ? "flex h-[48px] items-center justify-center gap-1.5 rounded-xl border-2 border-[#1A7A52] bg-white px-2 text-[14px] font-bold text-[#1A7A52] transition-transform active:scale-[0.98]"
                        : "flex h-[48px] items-center justify-center gap-1.5 rounded-xl bg-gradient-to-b from-[#1A7A52] to-[#14634A] px-2 text-[14px] font-bold text-white shadow-sm transition-transform active:scale-[0.98]"
                    }
                  >
