...
export function RichComparisonCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      {/* Top ranked ribbon */}
      {product.badge && (
        <div className="flex items-center gap-1.5 bg-[#1A7A52] px-5 py-1.5 text-[12px] font-bold uppercase tracking-wide text-white">
      ...
      <div className="p-4 sm:p-7">
        ...
        <div className="flex flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <div className="text-right">
              ...
              <p className="mt-0.5 text-[10px] font-bold uppercase tracking-wide text-[#1A7A52] sm:text-[11px]">{product.ratingLabel}</p>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg bg-[#1A7A52] px-2.5 py-1 text-white sm:rounded-xl sm:px-3 sm:py-1.5">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:mt-5 sm:gap-5 lg:flex-row lg:items-start">
          <div className="min-w-0 flex-1 space-y-3.5 sm:space-y-4">
            ...
            {(treatments.length > 0 || startingPlan?.price) && (
              <div className="rounded-xl border border-gray-100 bg-[#F1F8F4] p-3.5 sm:p-4">
                {treatments.length > 0 && (
                  <div>
          ...
          <div className="flex shrink-0 flex-row items-center gap-3 lg:w-[220px] lg:flex-col lg:items-stretch lg:gap-2.5 lg:rounded-xl lg:bg-[#F1F8F4] lg:p-4">
            {startingPlan?.price && (
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-2 lg:w-full lg:flex-none">
              <ProviderCta
                ...
                className="flex h-[48px] w-full items-center justify-center gap-1.5 rounded-xl bg-[#1A7A52] text-[15px] font-bold text-white transition-colors hover:bg-[#14634A] sm:h-[50px]"
              >
                Visit Site
              ...
              <Link
                href={reviewHref}
                className="text-center text-[12.5px] font-semibold text-[#1A7A52] hover:underline"
              >
                Read full review
              </Link>
        ...
        {intro && (
          <div className="mt-4 border-t border-gray-100 pt-3.5 sm:mt-5 sm:pt-4">
            ...
            <Link
              href={reviewHref}
              className="mt-1.5 inline-flex items-center gap-1 text-[12.5px] font-semibold text-[#1A7A52] hover:underline sm:text-[13px]"
            >
